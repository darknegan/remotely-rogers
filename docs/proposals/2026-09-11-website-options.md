...
- New versions of all six cabin pages, with photos, description, amenities, location, house rules, and a way to book
- That cabin’s Airbnb reviews on each page
- The same website address and the same look you have now
- A check that the pages work on a phone and that a guest can still start a booking

**What this does not include**

- Changes to Home or the page that lists all cabins
- An easier path the next time you want something new added

**Please know this**

Future changes on the website pages will still be slow. We would still be working around Lodgify’s locks. If Lodgify changes how their booking buttons work, fixing that could turn into a separate job.
...
- A full website with all the same features you have today
- Reviews on each cabin page (the cards already written)
- Photos, amenities, and a way to book one cabin or several cabins together
- Your Activities, Recommendations, Work Stays, and Multi-Cabin pages, carried over
- Old cabin links from emails or Google will still take guests to the right page
- Fixes for any launch problems for the first 2 months for free

**What this does not include**

- New features that don't currently exist today, but if there is anything that you would like to get added we can negotiate new features.
